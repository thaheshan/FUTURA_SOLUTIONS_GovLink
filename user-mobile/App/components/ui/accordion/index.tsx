...
const accordionTitleTextStyle = tva({
  base: 'text-typography-900 font-bold flex-1 text-left dark:text-typography-100',
  parentVariants: {
    size: {
      sm: 'text-sm',
      md: 'text-base',
...
const accordionIconStyle = tva({
  base: 'text-typography-900 fill-none dark:text-typography-100',
  parentVariants: {
    size: {
      '2xs': 'h-3 w-3',
      'xs': 'h-3.5 w-3.5',
...
const accordionContentTextStyle = tva({
  base: 'text-typography-700 font-normal dark:text-typography-300',
  parentVariants: {
    size: {
      sm: 'text-sm ',
      md: 'text-base',
...
const Accordion = React.forwardRef<
  ...
  IAccordionProps
>(({ className, variant = 'unfilled', size = 'md', ...props }, ref) => {
  return (
    <UIAccordion
      ref={ref}
      {...props}
