...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center dark:border-[#3F3F46]',
...
const inputIconStyle = tva({
  base: 'justify-center items-center text-typography-400 fill-none mx-2',
  parentVariants: {
    size: {
      '2xs': 'h-3 w-3',
      'xs': 'h-3.5 w-3.5',
...
const inputFieldStyle = tva({
  base: 'flex-1 text-typography-900 dark:text-typography-100 py-auto px-3 placeholder:text-typography-400 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
...
cssInterop(UIInput.Icon, { className: 'className' }); 
