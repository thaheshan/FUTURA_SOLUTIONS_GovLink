...
type NICCorrectionsFormScreenProps = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'NICCorrectionsForm'>;
};
...
const NICCorrectionsFormScreen: React.FC<NICCorrectionsFormScreenProps> = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>NIC Corrections</Text>
...
export default NICCorrectionsFormScreen;