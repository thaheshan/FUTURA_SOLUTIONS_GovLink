...
interface AppointmentsHomeScreenProps {
  navigation: NativeStackNavigationProp<RootStackParamList, 'AppointmentsHome'>;
}

// Settings Icon Component
const SettingsIcon = ({ color = '#64748B', size = 24 }) => (
...
const AppointmentsHomeScreen: React.FC<AppointmentsHomeScreenProps> = ({ navigation }) => {
  return (
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.settingsButton} activeOpacity={0.7}>
            <SettingsIcon color="#64748B" size={24} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('BookAppointmentOptions')}
            activeOpacity={0.8}
          >
...
export default AppointmentsHomeScreen;