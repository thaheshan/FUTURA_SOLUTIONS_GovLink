...
import { FileDto, FileResponseDto } from 'src/modules/file';
import { FileService } from 'src/modules/file/services';
import { UserDto } from 'src/modules/user/dtos';
import { CATEGORY_EVENTS, POST_CATEGORY_CHANNEL } from '../constants';
...
interface CategoryData extends QueueEvent {
    data: {
        _id: string;
    };
}
...
export class PostService {
    ...
    public async findByIdOrSlug(
        ...
        const query =
            id instanceof Types.ObjectId || StringHelper.isObjectId(id) ?
                { _id: id } :
                { slug: id };
    ...
    private async categoryChangeUpdater(event: CategoryData) {
