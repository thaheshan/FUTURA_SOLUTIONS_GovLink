...
const templateMap = {
    ...
    'approved-performer-account': {
        name: 'Approve creator account',
        subject: 'Your account has been approved',
        desc: 'Notification email to creator when admin approved their account'
    },
    contact: {
        name: 'Contact email',
        subject: 'New contact',
    ...
    'new-performer-notify-admin': {
        name: 'Notify new creator to admin',
        subject: 'New model sign up',
        desc: 'Email notification to admin when having new creator register'
    },
    'performer-cancel-subscription': {
        name: 'Cancel susbscription email to creator',
        subject: 'Cancel Subscription',
        desc: 'Email notification to creator when user unfollows creator'
    },
    'performer-new-subscription': {
        name: 'New subscription email to creator',
        subject: 'New Subscription',
        desc: 'Email notification to creator when having new subscriber'
    },
    'performer-payment-success': {
        name: 'Payment success to creator',
        subject: 'New payment success',
        desc: 'Email to creator after user purchased their assets'
    },
    ...
    'update-order-status': {
        ...
        desc: 'Email notification to user when creator updates order status'
    },
