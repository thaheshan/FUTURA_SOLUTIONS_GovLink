    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                token = jwtService_1.jwtService.getTokenFromHeader(authHeader);
                if (!token) {
                    return [2 /*return*/, next()];
                }
                return [4 /*yield*/, jwtService_1.jwtService.verifyAccessToken(token)];
            case 1:
                decoded = _a.sent();
                req.user = decoded; // Minimal user data from token
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                return [3 /*break*/, 3];
