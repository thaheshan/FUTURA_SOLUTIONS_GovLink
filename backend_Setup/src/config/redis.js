...
var RedisClient = /** @class */ (function () {
    ...
    RedisClient.prototype.set = function (key, value, expireInSeconds) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        if (!expireInSeconds) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.client.setEx(key, expireInSeconds, value)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    ...
                    case 6:
                        error_2 = _a.sent();
                        console.error('Redis SET error:', error_2);
                        return [3 /*break*/, 7];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        console.error('Redis GET error:', error_3);
                        return [2 /*return*/, null];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        console.error('Redis DEL error:', error_4);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
